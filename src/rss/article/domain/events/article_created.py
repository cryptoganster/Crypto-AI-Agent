...
class ArticleCreated:
    """
    Domain Event emitido cuando se crea un nuevo Article.

    Este evento permite que otros aggregates (como Source) reaccionen
    automáticamente cuando se crean artículos.
    """
    ...
    _event_type: str = field(default="ArticleCreated")
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "ArticleCreated":
