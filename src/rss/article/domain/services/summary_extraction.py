"""Domain Service para generación de summaries de artículos RSS."""

import re
from typing import List, Optional

from src.rss.article.domain.aggregates.rss_article import RssArticle as Article
from src.rss.article.domain.interfaces.services.summary_extraction import (
...
class ArticleSummaryExtractionService(IArticleSummaryExtractionService):
    """
    Domain Service para generar summaries (resúmenes) de artículos RSS.
    ...
    PURE DOMAIN SERVICE: Sin dependencias externas, solo lógica de generación de summaries.
    """
    ...
    def __init__(self, keywords: Optional[List[str]] = None):
        """
        Inicializa el servicio de generación de summaries.
    ...
    def generate_summary(
        ...
        Args:
            article: Artículo del que generar summary (requiere content_markdown)
