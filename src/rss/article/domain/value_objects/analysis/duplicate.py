...
from src.rss.article.domain.value_objects.metadata.rss_article_id import ArticleId


@dataclass(frozen=True)
class RssArticleDuplicate:
    """
    ...
    @staticmethod
    def not_duplicate() -> "RssArticleDuplicate":
        """
        Crea instancia para artículo no duplicado.

        Factory method para crear RssArticleDuplicate indicando que el artículo
        no es un duplicado.

        Returns:
            RssArticleDuplicate con is_duplicate=False y duplicate_of_article_id=None
        ...
        Example:
            ...
            True
        """
        return RssArticleDuplicate(is_duplicate=False, duplicate_of_article_id=None)

    @staticmethod
    def duplicate_of(article_id: ArticleId) -> "RssArticleDuplicate":
        """
        ...
        Returns:
            RssArticleDuplicate con is_duplicate=True y duplicate_of_article_id establecido
        ...
        Example:
            ...
            >>> info = RssArticleDuplicate.duplicate_of(original_id)
            >>> info.is_duplicate
            True
        ...
        return RssArticleDuplicate(
            is_duplicate=True, duplicate_of_article_id=article_id
        )
    ...
    def mark_as_not_duplicate(self) -> "RssArticleDuplicate":
        """
        ...
        Returns:
            Nueva instancia de RssArticleDuplicate con is_duplicate=False
    ...
    def mark_as_duplicate_of(self, article_id: ArticleId) -> "RssArticleDuplicate":
        """
        ...
        Returns:
            Nueva instancia de RssArticleDuplicate con is_duplicate=True

        Raises:
            ValueError: Si article_id es None
        """
        return RssArticleDuplicate.duplicate_of(article_id)
